...
./gradlew publishTestPythonPublicationToMavenRepository -PsigningKey="$SIGNING_KEY" -PsigningPassword="$SIGNING_PASSWORD" -PmavenCentralPwd="$MAVEN_PASSWORD" || exit 3
